...
config={
  ...
  'mode': 'report',
  'views':['features_RevMF_1d_Soc_Dem_p1','features_RevMF_1d_Inflow_Outflow_p1','features_RevMF_1d_Inflow_Outflow_p2',
           'features_RevMF_1d_Products_ActBalance_p1','features_RevMF_1d_Products_ActBalance_p2',
           'features_RevMF_1d_Targets_p1','features_RevMF_2d_Targets_correlations_p1','features_RevMF_2d_Targets_Inputs_correlations_p1',
           'features_RevMF_2d_Targets_Inputs_correlations_p2','features_RevMF_2d_Targets_Inputs_correlations_p3',
           'features_RevMF_2d_Targets_Inputs_correlations_p4','RevMF_learning_curve'],
  'RevMF_learning_curve':{
  ...
  'features_RevMF_1d_Soc_Dem_p1':{
     'annotation': 'Age, Sex, Tenure train/test distributions p1.',
     'type':'1d_train_test',
     'output_filename':'features_RevMF_1d_Soc_Dem_p1',
     'layout':{'nrows':1, 'ncols':3},
     'size': [8.5,2.5],
     'features':['Sex','Age','Tenure']
  },
  'features_RevMF_1d_Inflow_Outflow_p1':{
     'annotation': 'Inflow/Outflow distribution p1.',
     'type':'1d_train_test',
     'output_filename':'features_RevMF_1d_Inflow_Outflow_p1',
  ...
  'features_RevMF_1d_Inflow_Outflow_p2':{
     'annotation': 'Inflow/Outflow distribution p2.',
     'type':'1d_train_test',
     'output_filename':'features_RevMF_1d_Inflow_Outflow_p2',
     'layout':{'nrows':2, 'ncols':4},
     'size': [8.5,5.0],
  ...
  'features_RevMF_2d_Targets_Inputs_correlations_p3':{
     'annotation': 'Revenue MF VS inputs correlations p3.',
     'type':'2d_train_correlations',
     'output_filename':'features_RevMF_2d_Targets_Inputs_correlations_p3',
     'layout':{'nrows':2, 'ncols':3},
     'size': [8.5,5.0],
  ...
  'features_RevMF_2d_Targets_Inputs_correlations_p4':{
     'annotation': 'Revenue MF VS inputs correlations p4.',
     'type':'2d_train_correlations',
     'output_filename':'features_RevMF_2d_Targets_Inputs_correlations_p4',
     'layout':{'nrows':1, 'ncols':2},
     'size': [8.5,5.0],
     'features':[['Revenue_MF','TransactionsDeb'], ['Revenue_MF','TransactionsDeb_CA']]
  },
  'features_RevMF_2d_Targets_correlations_p1':{
     'annotation': 'Revenue MF VS targets correlations p1.',
     'type':'2d_train_correlations',
     'output_filename':'features_RevMF_2d_Targets_correlations_p1',
     'layout':{'nrows':1, 'ncols':3},
     'size': [8.5,5.0],
