...
config={
  ...
  'compatibility_version':'1.4pre',
  'command': 'bin/kbc_direct_marketing_mock.py -c configs/conf_ridgeCV_Revenue_MF_cff.py',
  'latex_main': 'latex/report.tex',
  'model':{
   'type':'vanilla_LassoLarsIC_regression',
...
#   'features_1d_Targets_p1', 'features_2d_Targets_correlations_p1'],
  ...
  'learning_curve':{
     'annotation': 'Learning curve RidgeCV',
     'type':'regression_model_lasso_lars_ic',
     'output_filename':'Revenue_MF_lasso_lars_ic_criterion',
