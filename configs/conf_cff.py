...
config={'annotation': 'Advanced data plotting and ML processing. Example annotation',
 'command': 'bin/kbc_direc_marketing_mock.py -c configs/conf_cff.py',
 ...
 'features_1d_train_test_p1':{
     'annotation': 'Age,SibSp,Parch,Sex, Pclass, Embarked train/test distributions.',
     'type':'1d_train_test',
     'output_filename':'features_1d_train_test_p1',
     'layout':{'nrows':2, 'ncols':3},
     'size': [8.5,5.0],
     'features':['Age','SibSp','Parch','Sex','Pclass','Embarked']
 ...
 'features_1d_train_test_p2':{
  ...
  'Embarked':{
        ...
        'class1_line_train':'',
        'class1_line_test':'',
        'class1_label_train':'Survived (train)',
        'class1_label_test':'Survived (test)',
        'class2_marker_test':'.',
  ...
  'train_data_provider':{
        'input_file':'data/2019-12-05/train.csv'
  }
 }