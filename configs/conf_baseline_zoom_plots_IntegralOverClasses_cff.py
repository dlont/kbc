...
config={
  ...
  'mode': 'report',
  'views':['features_zoom_1d_Soc_Dem_p1','features_zoom_1d_Inflow_Outflow_p1','features_zoom_1d_Inflow_Outflow_p2', 
  'features_zoom_1d_Products_ActBalance_p1', 'features_zoom_1d_Products_ActBalance_p2',
  'features_zoom_1d_Targets_p1', 'features_zoom_2d_Targets_correlations_p1'],
  'features_zoom_1d_Soc_Dem_p1':{
     'annotation': 'Age, Sex, Tenure train/test distributions p1.',
     'type':'1d_train_test',
     'output_filename':'features_zoom_1d_Soc_Dem_p1',
     'layout':{'nrows':1, 'ncols':3},
     'size': [8.5,2.5],
     'features':['Sex','Age','Tenure']
  },
  'features_zoom_1d_Inflow_Outflow_p1':{
     'annotation': 'Inflow/Outflow distribution p1.',
     'type':'1d_train_test',
     'output_filename':'features_zoom_1d_Inflow_Outflow_p1',
  ...
  'features_zoom_1d_Inflow_Outflow_p2':{
     'annotation': 'Inflow/Outflow distribution p2.',
     'type':'1d_train_test',
     'output_filename':'features_zoom_1d_Inflow_Outflow_p2',
     'layout':{'nrows':2, 'ncols':4},
     'size': [8.5,5.0],
