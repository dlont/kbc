...
from dataprovider import SaleCCClassSelector, SaleMFClassSelector
config={
  ...
  'mode': 'report',
  'views':['features_zoom_CC_MF_1d_Soc_Dem_p1','features_zoom_CC_MF_1d_Inflow_Outflow_p1','features_zoom_CC_MF_1d_Inflow_Outflow_p2', 
  'features_zoom_CC_MF_1d_Products_ActBalance_p1', 'features_zoom_CC_MF_1d_Products_ActBalance_p2',
  'features_zoom_CC_MF_1d_Targets_p1'],
  'features_zoom_CC_MF_1d_Soc_Dem_p1':{
     'annotation': 'Age, Sex, Tenure train/test distributions p1.',
     'type':'1d_train_test',
     'output_filename':'features_zoom_CC_MF_1d_Soc_Dem_p1',
     'layout':{'nrows':1, 'ncols':3},
     'size': [8.5,2.5],
     'features':['Sex','Age','Tenure']
  },
  'features_zoom_CC_MF_1d_Inflow_Outflow_p1':{
     'annotation': 'Inflow/Outflow distribution p1.',
     'type':'1d_train_test',
     'output_filename':'features_zoom_CC_MF_1d_Inflow_Outflow_p1',
  ...
  'features_zoom_CC_MF_1d_Inflow_Outflow_p2':{
     'annotation': 'Inflow/Outflow distribution p2.',
     'type':'1d_train_test',
     'output_filename':'features_zoom_CC_MF_1d_Inflow_Outflow_p2',
     'layout':{'nrows':2, 'ncols':4},
     'size': [8.5,5.0],
  ...
  'features_zoom_CC_MF_1d_Targets_p1':{
     ...
     'type':'1d_train_test',
     'output_filename':'features_zoom_CC_MF_1d_Targets_p1',
     'layout':{'nrows':2, 'ncols':3},
     'size': [8.5,5.0],
  ...
  'Sex':{
        ...
        'class1':SaleCCClassSelector(1),
        'class2':SaleMFClassSelector(1),
        'class1_marker_test':'.',
        'class1_color_train':'r',
        'class1_color_test':'r',
        'class1_line_train':'',
        'class1_line_test':'',
        'class1_label_train':'Sale_CC=1 (train)',
        'class1_label_test':'Sale_CC=1 (test)',
        'class2_marker_test':'.',
        'class2_color_train':'b',
        'class2_color_test':'b',
        'class2_line_train':'',
        'class2_line_test':'',
        'class2_label_train':'Sale_MF=1 (train)',
        'class2_label_test':'Sale_MF=1 (test)',
  },
  'Age':{
        'data_provider':'model_data_provider',
        'title':'Age, years',
