...
config={
  ...
  'mode': 'report',
  'views':['learning_curve','output_classifier'],
  'learning_curve':{
     'annotation': 'Learning curve XGBoost',
     'type':'multiclassification_model_learning_curve',
  ...
  'output_classifier':{
     ...
     'type':'multiclassification_model_classifier_distribution',
     'output_filename':'multiclass_classifier_distribution',
     'layout':{'nrows':2, 'ncols':2},
     'size': [8.5,8.5],
     'distributions':['classifier','correlation_1','correlation_2','correlation_3'],
     'style':{
        'type' : 'numerical',
        'under_over_flow' : [False,False],
        'bins':linspace(-0.5,4.5,5,endpoint=False),
     },
     'class0_marker_train':'.',
     'class0_marker_test':'x',
     'class0_color_train':'g',
     'class0_color_test':'g',
     'class0_label_train':'1vs0 (train)',
     'class0_label_test':'1vs0 (test)',
     'class1_line_test':'',
     'class1_line_train':'',
     'class1_marker_train':'.',
     ...
     'class1_color_test':'r',
     'class1_label_train':'1vs0 (train)',
     'class1_label_test':'1vs0 (test)',
     'class2_marker_train':'.',
     'class2_marker_test':'x',
     'class2_color_train':'b',
     'class2_color_test':'b',
     'class2_label_train':'1vs3 (train)',
     'class2_label_test':'1vs3 (test)',
  }, 
